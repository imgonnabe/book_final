  ...
  <%@ include file="../menu.jsp"%>
    <main>
      <div class="main">
       ...
       <hr class="divider-w">
          <div class="container con" style="width: 100%; margin-bottom: 50px;">
             ...
             <div class="col-sm-8 col-sm-offset-1">
            	 ...
            	 <c:when test="${param.board eq 3 }"><img src="../board/모임.jpg" style="width: 600px;  height : 300px" class="rounded"></c:when>
                  ...
                  <div class="post-header font-alt">
                    ...
                    <div class="post-meta">By&nbsp;${bdetail.mid }| ${bdetail.bdate } | Comments : ${bdetail.commentcount}  | <a href="board?board=${bdetail.bcate}">${bdetail.stitle} </a>|&nbsp;<a href="#"></a>
		...
		<div class="comments">
			...
			<h4 class="comment-title font-alt"> ${bdetail.commentcount}개 댓글이 있습니다</h4>
			<div class="comment clearfix">
			<c:forEach items="${commentsList }" var="c" >
				<div class ="comment-content clearfix">
				<div class="comment-author font-alt">${c.mid}</div>
				<div class="comment-body"> ${c.comment } </div>
				<div class="cno">${c.cno}</div>
				<div class="comment-meta font-alt"><fmt:formatDate pattern="yyyy-MM-dd" value="${c.cdate }"/>
			...
			<c:otherwise>
			<h4 class="comment-title font-alt">댓글이 없습니다</h4>	
			</c:otherwise>
			</c:choose>
		</div>
       <!-- 댓글 창  -->
       ...
       <h4 class="comment-form-title font-alt">댓글을 작성하세요</h4>
       <c:choose>
