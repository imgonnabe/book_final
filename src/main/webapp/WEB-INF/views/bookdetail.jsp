                ...
                <div class="tab-pane active" id="buy">
                 ...
                 <c:if test="${sessionScope.mid ne null }">
                   <div class="col-sm-4 mb-sm-20">
                     <input class="form-control input-lg" type="number" name="amount"  max="${detail.bstock }" min="1" required="required" value="1"/>
                    </div>
                  ...
                  <c:if test="${sessionScope.mid eq null }">
                   <div class="col-sm-8"><a class="btn btn-lg btn-block btn-round btn-b" href="/login">회원만 이용가능합니다.</a></div>
                  </c:if> 
                 </form>
                </div>
				...
				<c:forEach items="${reviewsList }" var="r">				
					<div class="comment">
						...
						<div class="comment-content clearfix">
							...
							<c:if test="${sessionScope.mid eq r.mid || r.mgrade ge 3}">
							    <div>
